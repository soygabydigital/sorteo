...
@section('content')
    <section class="section">
        <div class="section-header">
            <h4 class="page__heading text-dark">EDITAR USUARIO</h4>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($user,['method'=>'PUT','route'=>['usuarios.update',$user->id]]) !!}
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="password">Pasword <b class="text-danger">*</b></label>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4">
                                    <div class="form-group"> 
                                        <label for="confirm-password">Confirmar Password <b class="text-danger">*</b></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('roles[]',$roles,$userRole,array('class'=>'form-control text-dark'))  !!}
