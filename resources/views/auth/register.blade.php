...
@section('content')
    <div class="card card-dark">
        <div class="card-header"><h4 style="color: #3e4095;">REGISTRAR</h4></div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="firstName" type="text"
                                   class="form-control text-dark{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                   name="name"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="password_confirmation" type="password" placeholder="Confirm account password"
                                   class="form-control text-dark{{ $errors->has('password_confirmation') ? ' is-invalid': '' }}"
